...
export const aiProviders: AIProvider[] = [
  ...
  },
  {
    ...
    name: 'xAI Grok',
    logo: '𝕏',
    description: 'xAI\'s Grok is available via X (Twitter) and the xAI API. Consumer plans use opt-in training; the API offers zero-data-retention options for enterprises.',
    versions: [
      {
        id: 'grok-consumer',
        name: 'Grok (X / SuperGrok)',
        plan: 'Free / Premium / SuperGrok',
        riskLevel: 'medium',
        dataUsedForTraining: false,
        dataRetention: '30 days (Private Chat deleted within 30 days)',
        humanReview: false,
        encryption: 'TLS 1.3 in transit, AES-256 GCM at rest',
        compliance: ['GDPR (enterprise)', 'CCPA'],
        description:
          'Grok consumer plans default to NOT using conversations for training — users must explicitly opt in via Settings > Data > "Improve the Model". Private Chat mode excludes conversations from training and deletes them within 30 days. Human review is limited to automated policy violation detection.',
        recommendations: [
          '✓ Training is opt-in — off by default',
          '✓ Use Private Chat mode for sensitive queries',
          '⚠️ Check your X data settings to confirm opt-out',
          '⚠️ Avoid personal or financial data in standard chat',
          '✓ Data generally deleted within 30 days',
        ],
      ...
      },
      {
        ...
        riskLevel: 'low',
        dataUsedForTraining: false,
        dataRetention: '30 days for abuse auditing (ZDR: no retention)',
        humanReview: false,
        encryption: 'TLS 1.3 in transit, AES-256 GCM at rest',
        compliance: ['SOC 2 Type II', 'GDPR', 'CCPA'],
        description:
          'xAI API never trains on inputs or outputs without explicit permission. Enterprise customers can enable Zero Data Retention (ZDR) — data is never persisted to servers. SOC 2 Type II certified.',
        recommendations: [
          '✓ No training on API data by default',
          '✓ Zero Data Retention (ZDR) available for enterprises',
          '✓ SOC 2 Type II certified',
          '✓ Suitable for sensitive business workflows',
          '✓ GDPR-compliant option available',
        ],
        sourceUrl: 'https://docs.x.ai/developers/faq/security',
      },
    ],
    policyLinks: [
      {
        title: 'xAI Privacy Policy',
        url: 'https://x.ai/legal/privacy-policy',
        description: 'xAI\'s privacy policy covering data collection, training opt-in, and user rights for Grok.',
        category: 'privacy',
        lastChecked: '2026-08-01',
      },
      {
        ...
        description: 'Frequently asked legal questions about Grok data usage, retention, and privacy controls.',
        category: 'terms',
        lastChecked: '2026-08-01',
      },
      {
        title: 'API Security FAQ',
        url: 'https://docs.x.ai/developers/faq/security',
        description: 'Security and data handling details for xAI API users including Zero Data Retention.',
        category: 'security',
        lastChecked: '2026-08-01',
      },
      {
        title: 'X Platform Privacy (Grok)',
        url: 'https://help.x.com/en/using-x/about-grok',
        description: 'X\'s help page explaining how Grok uses data within the X platform.',
        category: 'privacy',
        lastChecked: '2026-08-01',
      },
    ],
  },
  {
    ...
    name: 'Alibaba Qwen',
    logo: '🐙',
    description: 'Alibaba\'s Qwen (Tongyi Qianwen) offers a free consumer chat app and a cloud API. Consumer privacy documentation is limited; the API has stronger explicit guarantees.',
    versions: [
      {
        id: 'qwen-consumer',
        name: 'Qwen App (Free)',
        ...
        riskLevel: 'very-high',
        dataUsedForTraining: true,
        dataRetention: 'Not clearly disclosed',
        humanReview: false,
        encryption: 'TLS 1.2+ in transit',
        compliance: [],
        description:
          'The free Qwen consumer app lacks comprehensive official privacy documentation. Training data usage is not clearly disclosed. Data is stored on Alibaba Cloud servers (primarily in China), raising data residency concerns. No SOC 2, ISO 27001, or GDPR certifications have been confirmed for the consumer product.',
        recommendations: [
          '❌ AVOID entering personal information',
          '❌ AVOID entering financial or health data',
          '❌ AVOID entering confidential business information',
          '⚠️ Data stored on servers in China — consider jurisdiction risk',
          '⚠️ No confirmed GDPR compliance for consumer product',
          '⚠️ Training data usage policy unclear',
        ],
        sourceUrl: 'https://qwen.ai/privacypolicy',
      },
      {
        id: 'qwen-api',
        ...
        riskLevel: 'medium',
        dataUsedForTraining: false,
        dataRetention: 'Monitoring logs: 30 days',
        humanReview: false,
        encryption: 'TLS 1.2+ in transit, AES-256 at rest',
        compliance: ['Alibaba Cloud compliance framework'],
        description:
          'The Qwen Cloud API explicitly does NOT use API inputs or outputs to train or improve models. Monitoring data is retained for 30 days. Encryption standards follow Alibaba Cloud practices. However, data residency and international compliance certifications (SOC 2, ISO 27001) are not clearly documented for non-Chinese customers.',
        recommendations: [
          '✓ API does not use data for model training',
          '✓ AES-256 encryption at rest',
          '⚠️ Data residency may be in China — check Alibaba Cloud region settings',
          '⚠️ No confirmed SOC 2 or ISO 27001 certification',
          '⚠️ Review jurisdiction requirements for your industry',
          '⚠️ Not recommended for GDPR-regulated personal data without further verification',
        ],
        sourceUrl: 'https://www.alibabacloud.com/help/en/model-studio/qwen-api-reference/',
      },
    ],
    policyLinks: [
      {
        title: 'Qwen Privacy Policy',
        url: 'https://qwen.ai/privacypolicy',
        description: 'Qwen\'s official privacy policy for the consumer app.',
        category: 'privacy',
        lastChecked: '2026-08-01',
      },
      {
        title: 'Qwen Cloud Data Security',
        url: 'https://www.alibabacloud.com/help/en/model-studio/qwen-api-reference/',
        description: 'Alibaba Cloud Model Studio API reference including data handling and security practices.',
        category: 'security',
        lastChecked: '2026-08-01',
      },
      {
        title: 'Qwen Code Terms & Privacy',
        url: 'https://qwenlm.github.io/qwen-code-docs/en/users/support/tos-privacy/',
        description: 'Terms of service and privacy policy for Qwen Code, confirming no training on user code.',
        category: 'terms',
        lastChecked: '2026-08-01',
      },
    ],
